...
<user_guide>
Documentation about the bum CLI/TUI (Build Using Multiagents) — including configuration, keyboard shortcuts, MCP servers, skills, theming, plugins, and more — is stored as `.md` files in `~/.bum/docs/user-guide/` (or `$BUM_HOME/docs/user-guide/`). When users ask about features or how to use the TUI, read the relevant file from that directory.
</user_guide>
${%- endif %}