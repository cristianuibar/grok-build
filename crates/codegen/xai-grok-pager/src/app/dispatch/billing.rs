...
pub(crate) const FREE_USAGE_USER_MESSAGE: &str = "You\u{2019}ve reached your free bum usage limit for now. Get SuperGrok for much higher limits, or try again later: https://grok.com/supergrok?referrer=grok-build";
...
fn open_supergrok_upsell(
    ...
    let options = vec![
        ...
        QuestionOption {
            ...
            description: "Get the most out of bum. Highest usage limits.".into(),
            preview: None,
