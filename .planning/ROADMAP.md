...
**Plans**: 4/7 complete — `10-01` establishes the disabled typed Responses profile; `10-06` and `10-07` restore compatibility; `10-02` repairs terminal SSE text fallback; remaining execution plans are in `.planning/phases/10-codex-responses-wire-parity/`.
...
| 10. Codex Responses wire parity | 4/7 | In Progress |  |
