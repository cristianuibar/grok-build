...
**Plans**: 2/7 complete — `10-01` establishes the disabled typed Responses profile and `10-06` restores shell constructor compatibility; remaining execution plans are in `.planning/phases/10-codex-responses-wire-parity/`.
...
| 10. Codex Responses wire parity | 2/7 | In Progress |  |
